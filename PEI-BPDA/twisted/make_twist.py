...
# chain along 010 + origin from (c,0,c)
for atom in atoms_1_center:
    x = atom[1] + c_average
    y = atom[3] 
    z = atom[2] + c_average
...
# chain along 001 + origin from (c,c,c)
for atom in atoms_1_center:
    x = atom[1] + c_average
    y = atom[2] + c_average
    z = atom[3] + c_average
...
# chain along -100 + origin from (c,c,2c)
for atom in atoms_1_center:
    x = -atom[3] + c_average
    y = atom[2] + c_average
    z = atom[1] + 2.0* c_average
    atoms_blend.append([atom[0], x,y,z])

# chain along 001 + origin from (0,c,2c)
for atom in atoms_1_center:
    x = atom[1] 
    y = atom[2] + c_average
    z = atom[3] + 2.0* c_average
    atoms_blend.append([atom[0], x,y,z])
